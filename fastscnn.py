...
Original: https://github.com/kshitizrimal/Fast-SCNN/blob/master/tf_2_0_fast_scnn.py
"""
...
def build(input_shape):
    ...
    classes_maybe = 2#19
    classifier = conv_block(classifier, 'conv', classes_maybe, (1, 1), strides=(1, 1), padding='same', relu=True)
